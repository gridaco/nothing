...
| `svg-polygon.svg` · `svg-polyline.svg` | The points shapes: unsupported elements until their rung lands, declared by name. Both lower into the path vocabulary the contract already carries. |
