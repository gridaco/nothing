...
Baseline HTML fixtures for the HTML+CSS embed renderer (`crates/htmlcss/src/`).
...
4. Verify: `cargo test -p htmlcss -- --test-threads=1`
...
cargo test -p htmlcss -- --test-threads=1
