...
| D-D | htmlcss font-provider seam (flagged open at M4) | Phase 4 HTML entry (study starts Phase 0) | the [WG seam study](./font-provider-seam.md) — evidence complete; decision open |
