...
**Question.** Where is the feature on the grida side today? What
...
- For layout fixtures: the measured `viewport.height` from the grida
  natural cull.
...
render-reftest skill. A 96% score on a sparse fixture can mask a
