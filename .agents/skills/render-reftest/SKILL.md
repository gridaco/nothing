...
```sh
python https://github.com/gridaco/grida/blob/main/.tools/figma_archive.py \
...
#    https://github.com/gridaco/grida/blob/main/docs/wg/feat-fig/refig-testing.md if/when it exists)
npx tsx https://github.com/gridaco/grida/blob/main/packages/grida-canvas-io-figma/refig-render.ts \
...
pnpm -C packages/grida-reftest exec tsx .agents/skills/render-reftest/scripts/refbrowser_render.ts \
  --suite   fixtures/test-html/suites/L0.exact.json \
