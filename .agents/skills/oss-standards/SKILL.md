...
description: >
  ...
  opening any PR against `gridaco/nothing` or when finalizing work for
  review.
---
...
[`security`](https://github.com/gridaco/grida/blob/main/.agents/skills/security/SKILL.md) skill — `GRIDA-SEC-<id>` tags, the
...
- **Ship-or-draft is the doc taxonomy gate.** `draft: true` is the
  ...
  [`docs/AGENTS.md`](https://github.com/gridaco/grida/blob/main/docs/AGENTS.md).
...
See also: [`security`](https://github.com/gridaco/grida/blob/main/.agents/skills/security/SKILL.md),
[`links`](../links/SKILL.md), [`etiology`](../etiology/SKILL.md),
[`naming`](../naming/SKILL.md), [`code-ts`](https://github.com/gridaco/grida/blob/main/.agents/skills/code-ts/SKILL.md),
[`code-react`](https://github.com/gridaco/grida/blob/main/.agents/skills/code-react/SKILL.md),
