...
describe("actual browser executable architecture", () => {
  it.each([
    [0x0100000c, "arm64"],
    [0x01000007, "x64"],
  ] as const)("reads Mach-O CPU %i", (cpu, arch) => {
