...
///
/// Oracle v5 retains the face's `hhea` ascent/descent metric policy as the
...
/// One shaping cluster's complete source/glyph cardinality at oracle v5.
///
...
/// The immutable resolved text layout at oracle v5: one style run of
...
impl ResolvedTextLayout {
    ...
    /// Shaping clusters in logical order. Oracle v5's admitted LTR profile
    ...
    /// The placed glyphs in visual order — which at oracle v5 is also
