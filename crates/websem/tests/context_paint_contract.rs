...
fn an_unindexed_nested_use_is_unknown_not_empty() {
    let source = document(
        r##"<defs><linearGradient id="g"><stop offset="0" stop-color="red"/><stop offset="1" stop-color="blue"/></linearGradient><rect id="leaf" x="8" y="8" width="24" height="24" fill="context-fill"/><g id="outer"><path d="not path data"/><use href="#leaf" fill="url(#g)"/></g></defs><use href="#outer"/>"##,
    );
    let best = SvgFrameSource::from_standalone_svg_best_effort(source.as_str(), viewport())
