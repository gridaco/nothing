...
async fn demo_strokes() -> Scene {
    ...
    root_container_node.layout_dimensions.layout_target_width = Some(1000.0);
    root_container_node.layout_dimensions.layout_target_height = Some(1200.0);
        ...
        ellipse.strokes = Paints::new([
            Paint::RadialGradient(RadialGradientPaint {
                ...
                stops: vec![
                    ...
                    GradientStop {
                        offset: 1.0,
                        color: CGColor::from_rgba(255, 0, 0, 0).into(), // Transparent edge
                    },
                ],
                opacity: 1.0,
                blend_mode: BlendMode::Normal,
        ...
        polygon.strokes = Paints::new([
            ...
            Paint::LinearGradient(LinearGradientPaint {
                ...
                stops: vec![
                    ...
                    GradientStop {
                        offset: 1.0,
                        color: CGColor::TRANSPARENT.into(),
                    },
                ],
                opacity: 0.6,
                ..Default::default()
            ...
            Paint::RadialGradient(RadialGradientPaint {
                ...
                stops: vec![
                    GradientStop {
                        offset: 0.0,
                        color: CGColor::from_rgba(255, 255, 0, 255).into(), // Yellow highlight
                    },
                    GradientStop {
                        offset: 1.0,
                        color: CGColor::from_rgba(255, 255, 0, 0).into(), // Transparent
                    },
                ],
                opacity: 0.5,
                blend_mode: BlendMode::Normal,
