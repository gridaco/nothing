...
use crate::svg::dom::attrs::parse_length_px;
use crate::svg::dom::element::get_attr;
use crate::svg::dom::href::href_attr;
...
pub enum FilterEffect {
    ...
    Image {
        href: String,
        par: crate::svg::dom::attrs::PreserveAspectRatio,
    },
...
fn resolve_color_property(
    ...
    use crate::svg::dom::attrs::{parse_paint, Paint};
...
pub(crate) fn resolve_current_color(dom: &DemoDom, start: &DemoNode) -> Color {
    use crate::svg::dom::attrs::parse_color;
...
fn parse_drop_shadow(node: &DemoNode, is_first: bool) -> Option<FilterEffect> {
    ...
    let base = match crate::svg::dom::attrs::parse_paint(&raw_color) {
        Some(crate::svg::dom::attrs::Paint::Color(c)) => c,
        _ => Color::BLACK,
    };
...
fn parse_fe_image(node: &DemoNode) -> Option<FilterEffect> {
    use crate::svg::dom::attrs::parse_preserve_aspect_ratio;
