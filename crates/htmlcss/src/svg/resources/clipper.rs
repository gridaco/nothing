...
use crate::svg::dom::attrs::{parse_length_px, parse_paint, parse_points, parse_transform};
use crate::svg::dom::element::{get_attr, ElementKind};
use crate::svg::dom::href::{href_attr, same_document_fragment};
use crate::svg::dom::path_d::parse_path;
use crate::svg::layout::transform::{transform_origin_for, wrap_with_origin};
use crate::svg::paint::scoped_svg_paint_state::{ClipFrame, PaintCtx};
...
fn build_child_path(
    ...
    if !crate::svg::paint::visibility::is_painted(node) {
        return Some(None);
    }
