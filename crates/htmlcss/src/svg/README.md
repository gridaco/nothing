...
- [`crates/grida/src/import/svg/`](../../../grida/src/import/svg/) — SVG → Grida canvas
  IR (uses usvg). Different role: _converter_.
- [`crates/grida/src/formats/svg/`](../../../grida/src/formats/svg/) — string-level SVG
...
- **Style**: temporary SVG CSS subset. Full Stylo integration remains
  ...
  complete.
- **Image**: `<image>` via [`crate::ImageProvider`].
...
| Renderer file (`crates/htmlcss/src/svg/`) | Blink anchor (`third_party/blink/renderer/`)                                          |
| -------------------------------------------- | ------------------------------------------------------------------------------------- |
...
- [`crates/htmlcss/src/`](../) — The host pipeline.
- [`crates/grida/src/import/svg/`](../../../grida/src/import/svg/) — SVG → canvas IR (different role).
- [`crates/grida/src/formats/svg/`](../../../grida/src/formats/svg/) — string-level SVG tooling (different role).
