...
impl Stylesheet {
    pub fn collect(dom: &DemoDom, css: &dyn crate::svg::CssLoader) -> Self {
...
/// stylesheet bodies into a [`crate::svg::CssLoader`] before
...
mod tests {
    ...
    impl crate::svg::CssLoader for MapLoader {
