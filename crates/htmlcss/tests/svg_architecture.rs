...
const SVG_ROOT_REL: &str = "src/svg";
...
/// Known follow-ups: file-relative paths (under `src/svg/`)
...
const ALLOWLIST: &[(&str, &str)] = &[
    ...
    ("geometry/basic_shape.rs", "crate::svg::dom"),
];
    ...
    if !violations.is_empty() {
        panic!(
            "architectural rule violated for `{}/`:\n  {}\n\n\
             ...
             tests/svg_architecture.rs for the rules.\n\
