...
// Re-export the layer effects aggregate from its home in `cg::fe`
// (relocated there by the painter-narrowing seam, gridaco/nothing#31 —
// it is a pure composition of `Fe*` effect types with no model coupling).
pub use crate::cg::fe::LayerEffects;
