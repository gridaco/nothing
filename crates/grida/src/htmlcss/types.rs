//! CSS-specific type enums that don't exist in `grida::cg::types`.
//!
//! These model CSS semantics that have no direct equivalent in the design-tool
//! schema. Types that DO align 1:1 with grida (e.g. `BlendMode`, `TextAlign`,
//! `FontWeight`) are reused from `grida::cg::prelude` instead.
