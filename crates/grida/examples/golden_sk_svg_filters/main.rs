...
use grida::painter::gradient::linear_gradient_paint;
...
fn usvg_linear_gradient_to_linear_gradient_paint(
    ...
    // Convert spread method to tile mode (grida::cg::TileMode, not skia_safe::TileMode)
    let tile_mode = match gradient.spread_method() {
        usvg::SpreadMethod::Pad => grida::cg::TileMode::Clamp,
        usvg::SpreadMethod::Reflect => grida::cg::TileMode::Mirror,
        usvg::SpreadMethod::Repeat => grida::cg::TileMode::Repeated,
    };
    ...
    LinearGradientPaint {
        ...
        stops,
        opacity: 1.0,
        blend_mode: grida::cg::BlendMode::Normal,
    }
}
