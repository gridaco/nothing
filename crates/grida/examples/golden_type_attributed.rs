...
use grida::text::attributed_paragraph::build_attributed_paragraph;
...
fn main() {
    ...
    let geist_tf = font_mgr
        .new_from_data(grida::embedded_fonts::geist::BYTES, None)
        .unwrap();
    let geist_mono_tf = font_mgr
        .new_from_data(grida::embedded_fonts::geistmono::BYTES, None)
        .unwrap();
