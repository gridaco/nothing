...
//! `grida::painter::cvt::sk_paint_stack`, which combines multiple paints into a single
//! optimized shader for improved performance.
//!
//! ## What it demonstrates:
//! - Uses the core `Paint` types from `grida::cg::types`
//! - Converts paints to Skia using `grida::painter::cvt::sk_paint_stack`
...
use grida::{cg::types::*, cg::*, painter::paint, runtime::image_repository::ImageRepository};
