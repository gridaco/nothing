...
```bash
cargo run -p grida --example skia_bench_primitives --features native-gl-context --release
```
...
Benchmark source: `crates/grida/examples/skia_bench/skia_bench_downscale.rs`
