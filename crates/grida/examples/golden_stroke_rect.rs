...
use grida::painter::paint::shader_from_paint;
use grida::shape::stroke_rect::stroke_geometry_rectangular;
...
fn main() {
    ...
    println!("Saved crates/grida/goldens/stroke_rect.png");
}
...
impl DemoConfig {
    fn new() -> Self {
        Self {
            ...
            stroke_paint: grida::cg::Paint::LinearGradient(LinearGradientPaint {
...
fn draw_fill(canvas: &Canvas, config: &DemoConfig, align: StrokeAlign) {
    ...
    let fill_paint = grida::cg::Paint::Solid(SolidPaint {
        active: true,
