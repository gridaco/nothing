...
//!
//! Builds a visually rich 1600×900 composition that showcases the grida engine's
...
use grida::cg::fe::*;
use grida::cg::stroke_width::SingularStrokeWidth;

// ═══════════════════════════════════════════════════════════════════════════
// Palette
// ═══════════════════════════════════════════════════════════════════════════

const BG: CGColor = CGColor {
    r: 14,
    g: 14,
    b: 18,
    a: 255,
...
const PURPLE_DEEP: CGColor = CGColor {
    r: 88,
    g: 28,
    b: 180,
    a: 255,
};
const PURPLE_LIGHT: CGColor = CGColor {
    r: 168,
    g: 85,
    b: 247,
    a: 255,
};
const BLUE_ELECTRIC: CGColor = CGColor {
    r: 56,
    g: 130,
    b: 255,
    a: 255,
};
const BLUE_DEEP: CGColor = CGColor {
    r: 30,
    g: 64,
    b: 175,
    a: 255,
};
const CYAN_GLOW: CGColor = CGColor {
    r: 34,
    g: 211,
    b: 238,
    a: 255,
};
const AMBER: CGColor = CGColor {
    r: 245,
    g: 158,
    b: 11,
    a: 255,
};
const AMBER_WARM: CGColor = CGColor {
    r: 251,
    g: 191,
    b: 36,
    a: 255,
};
const ROSE: CGColor = CGColor {
    r: 244,
    g: 63,
    b: 94,
    a: 255,
};
const WHITE_DIM: CGColor = CGColor {
    r: 255,
    g: 255,
    b: 255,
    a: 18,
};
const WHITE_FAINT: CGColor = CGColor {
    r: 255,
    g: 255,
    b: 255,
    a: 8,
