...
use grida::cg::alignment::Alignment;
use grida::cg::color::CGColor;
use grida::cg::fe::*;
use grida::cg::stroke_dasharray::StrokeDashArray;
use grida::cg::stroke_width::{RectangularStrokeWidth, SingularStrokeWidth, StrokeWidth};
use grida::cg::tilemode::TileMode;
use grida::cg::types::*;
...
fn fixture_roundtrip_all_grida_files() {
    ...
    for entry in entries {
        ...
        if path.extension().map(|e| e == "grida").unwrap_or(false) {
            ...
            let result = grida::io::io_grida_file::decode_with_id_map(&bytes)
