...
const CANONICAL_EXAMPLES: [Example; 8] = [
    (
        ...
        include_str!("../../../fixtures/test-n0-xml/cases/nested-rects.n0.xml"),
        (96, 80),
    ),
    (
        "unit-path",
        "../../fixtures/test-n0-xml/cases/unit-path.n0.xml",
        include_str!("../../../fixtures/test-n0-xml/cases/unit-path.n0.xml"),
        (96, 80),
    ),
    (
        "dynamic-slide",
        "../../fixtures/test-n0-xml/examples/dynamic-slide.n0.xml",
        include_str!("../../../fixtures/test-n0-xml/examples/dynamic-slide.n0.xml"),
        (1280, 720),
    ),
    (
        "rich-fills",
        "../../fixtures/test-n0-xml/examples/rich-fills.n0.xml",
        include_str!("../../../fixtures/test-n0-xml/examples/rich-fills.n0.xml"),
        (720, 300),
    ),
    (
        "rich-strokes",
        "../../fixtures/test-n0-xml/examples/rich-strokes.n0.xml",
        include_str!("../../../fixtures/test-n0-xml/examples/rich-strokes.n0.xml"),
        (720, 320),
    ),
    (
        "source-becomes-surface",
        "../../fixtures/test-n0-xml/examples/source-becomes-surface.n0.xml",
        include_str!("../../../fixtures/test-n0-xml/examples/source-becomes-surface.n0.xml"),
        (1600, 1000),
    ),
    (
        "rounded-surfaces",
        "../../fixtures/test-n0-xml/examples/rounded-surfaces.n0.xml",
        include_str!("../../../fixtures/test-n0-xml/examples/rounded-surfaces.n0.xml"),
        (1440, 900),
    ),
    (
        "per-side-strokes",
        "../../fixtures/test-n0-xml/examples/per-side-strokes.n0.xml",
        include_str!("../../../fixtures/test-n0-xml/examples/per-side-strokes.n0.xml"),
        (1200, 760),
    ),
];
...
const AUTHORED_SHOWCASES: [Example; 7] = [
    (
        ...
        include_str!("../../../fixtures/test-n0-xml/examples/rich-text.n0.xml"),
        (1280, 800),
    ),
    (
        "prism-launch",
        "../../fixtures/test-n0-xml/examples/prism-launch.n0.xml",
        include_str!("../../../fixtures/test-n0-xml/examples/prism-launch.n0.xml"),
        (1440, 900),
    ),
    (
        "pulse-analytics",
        "../../fixtures/test-n0-xml/examples/pulse-analytics.n0.xml",
        include_str!("../../../fixtures/test-n0-xml/examples/pulse-analytics.n0.xml"),
        (1440, 960),
    ),
    (
        "nocturne-transit",
        "../../fixtures/test-n0-xml/examples/nocturne-transit.n0.xml",
        include_str!("../../../fixtures/test-n0-xml/examples/nocturne-transit.n0.xml"),
        (1400, 900),
    ),
    (
        "rfc-only-keynote",
        "../../fixtures/test-n0-xml/examples/rfc-only-keynote.n0.xml",
        include_str!("../../../fixtures/test-n0-xml/examples/rfc-only-keynote.n0.xml"),
        (960, 540),
    ),
    (
        "rfc-only-dashboard",
        "../../fixtures/test-n0-xml/examples/rfc-only-dashboard.n0.xml",
        include_str!("../../../fixtures/test-n0-xml/examples/rfc-only-dashboard.n0.xml"),
        (960, 640),
    ),
    (
        "rfc-only-transit",
        "../../fixtures/test-n0-xml/examples/rfc-only-transit.n0.xml",
        include_str!("../../../fixtures/test-n0-xml/examples/rfc-only-transit.n0.xml"),
        (1000, 620),
    ),
];
